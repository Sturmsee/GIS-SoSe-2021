...
function max(para1: number, para2: number): number {
    if (para1 > para2) {
        return para1;
    } else {
        return para2;
...
function leapyears(year: number): void {
    do {
...
function chess(): void {
    ...
    for (let index: number = 0; index <= 8; index++) {
        for (let index1: number = 0; index1 < 4; index1++) {
           if (index % 2 == 0) {
                board += " " + "#";
            } else {
                board += "#" + " ";
...
function chessModular(size: number): void {
    let board: string = "";
    for (let index: number = 0; index <= size; index++) {
        for (let index1: number = 0; index1 < size / 2; index1++) {
           if (index % 2 == 0) {
                board += " " + "#";
            } else {
                board += "#" + " ";
